...
export default function AddressForm({ title, data }) {
  ...
  if (addressForm.formState.isLoading) return <div>Loading...</div>
              ...
              <FormItem>
                ...
                <FormControl>
                  ...
                  >
                    ...
                    <SelectContent>
                      {thaiDistrict.filter((district) => district.province_id == addressForm.watch("province")).map((district) => (
              ...
              <FormItem>
                ...
                <FormControl>
                  ...
                  >
                    ...
                    <SelectContent>
                      {thaiSubdistrict.filter((subdistrict) => subdistrict.amphure_id == addressForm.watch("district")).map((subdistrict) => (
